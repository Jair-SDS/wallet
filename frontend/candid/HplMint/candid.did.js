export const idlFactory = ({ IDL }) => {
  ...
  const Stats = IDL.Record({
    "tokens" : IDL.Vec(
      IDL.Record({ "backlogSize" : IDL.Nat, "symbol" : IDL.Text })
    ),
  });
  ...
  return IDL.Service({
    ...
    "burnAndWithdraw" : IDL.Func(
        [
          ...
          VirtualAccountId,
          IDL.Nat,
          IDL.Tuple(IDL.Principal, IDL.Opt(Subaccount)),
        ],
        [Result_8],
        [],
      ),
    ...
    "mint" : IDL.Func(
        [
          IDL.Text,
          IDL.Tuple(IDL.Principal, VirtualAccountId),
    ...
    "queryIcrc1Journal" : IDL.Func(
        [IDL.Opt(IDL.Nat)],
        [IDL.Vec(JournalRecord__1), IDL.Nat],
        ["query"],
      ),
    ...
    "registerFt" : IDL.Func(
        [IDL.Principal, IDL.Text, ExchangeRatio, IDL.Nat8, IDL.Text],
        [Result_3],
        [],
      ),
    "stats" : IDL.Func([], [Stats], ["query"]),
    "tokenInfo" : IDL.Func([IDL.Text], [Result_2], ["query"]),
    "usableBalance" : IDL.Func(
        [IDL.Text, IDL.Principal],
        [Result_1],
        ["query"],
      ),
    "withdrawCredit" : IDL.Func(
        [IDL.Text, IDL.Tuple(IDL.Principal, IDL.Opt(Subaccount))],
        [Result],
        [],
      ),
  });
