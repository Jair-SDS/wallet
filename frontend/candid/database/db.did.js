export const idlFactory = ({ IDL }) => {
  ...
  const WalletDatabase = IDL.Service({
    ...
    "pullHplCount" : IDL.Func(
        [IDL.Nat32, IDL.Opt(IDL.Text), IDL.Nat],
        [IDL.Vec(HplCountDocument)],
        ["query"],
      ),
    "pullHplSubaccounts" : IDL.Func(
        [IDL.Nat32, IDL.Opt(IDL.Text), IDL.Nat],
        [IDL.Vec(HplSubAccountDocument)],
        ["query"],
      ),
    "pullHplVirtuals" : IDL.Func(
        [IDL.Nat32, IDL.Opt(IDL.Text), IDL.Nat],
        [IDL.Vec(HplVirtualDocument)],
        ["query"],
      ),
    ...
    "pushHplCount" : IDL.Func(
        [IDL.Vec(HplCountDocument)],
        [IDL.Vec(HplCountDocument)],
        [],
      ),
    "pushHplSubaccounts" : IDL.Func(
        [IDL.Vec(HplSubAccountDocument)],
        [IDL.Vec(HplSubAccountDocument)],
        [],
      ),
    "pushHplVirtuals" : IDL.Func(
        [IDL.Vec(HplVirtualDocument)],
        [IDL.Vec(HplVirtualDocument)],
        [],
      ),
