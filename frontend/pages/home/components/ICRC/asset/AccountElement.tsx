        ...
        <div className="flex flex-col items-start justify-center">
          {editNameId === subAccount.sub_account_id ? (
            <div className="flex flex-row items-center justify-start">
              ...
              />
              <div
                className="flex items-center justify-center p-1 ml-2 rounded cursor-pointer bg-RadioCheckColor"
                onClick={onSave}
              >
                <img src={CheckIcon} className="w-4 h-4 p-" alt="info-icon" />
              </div>
              <div
                className="flex items-center justify-center p-0 ml-2 rounded cursor-pointer bg-LockColor"
                onClick={onCancel}
              >
